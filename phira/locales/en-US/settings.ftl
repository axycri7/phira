...
item-effect-quality = GPU Effect Quality
item-effect-quality-sub = Lower the chart shader render resolution to reduce GPU bandwidth.
effect-quality-high = High
effect-quality-medium = Medium
effect-quality-low = Low
